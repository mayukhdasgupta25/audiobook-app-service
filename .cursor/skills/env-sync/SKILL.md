...
description: >-
  ...
  in Agent chat for app-service.
disable-model-invocation: true
---

# Env Sync (app-service)
...
This skill applies to **app-service** only:
...
Both files live at the app-service repo root.
...
```
# .env.example has NOMINATIM_USER_AGENT=AudioBookApp/1.0 (...)
# .env.development has no NOMINATIM_USER_AGENT line
→ append comment block + line from .env.example
```
